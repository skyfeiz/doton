...
(function(){
 ...
 +'       <ul>'
 +'       <li>'
 +'       <span class="sec_title sec_loginUp"><a href="${basePath}bottom/mobile/signUp">注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;册</a></span>'
 +'   </li>'
 +'   <li>'
 +'   <span class="sec_title sec_loginIn"><a href="${basePath}bottom/login">登&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;录</a></span>'
 +'   </li>'
 +'   <li>'
 ...
 +'       <div class="thi_title">'
 +'       <a class="target_title" href="${basePath}car/getMain">产品亮点</a>'
 +'       <a class="target_title" href="${basePath}car/getMain">车型介绍</a>'
 +'       <a class="target_title" href="${basePath}car/getMain">车型展示</a>'
 +'       <a class="target_title" href="${basePath}car/getMain">车型视频</a>'
 +'       <a class="target_title" href="${basePath}car/getMain">内外饰图片</a>'
 +'       <a class="target_title" href="${basePath}car/getMain">在线订购</a>'
 +'       </div>'
 +'       </li>'
 +'       <li>'
 +'       <span class="sec_title"><i class="buy_icon icon"></i>购买支持</span>'
 +'       <div class="thi_title">'
 +'       <a class="target_title" href="${basePath}customer/mobile/dealer">经销商查询</a>'
 +'       <a class="target_title" href="${basePath}support/mobile/testDrive">预约试驾</a>'
 +'       <a class="target_title" href="${basePath}support/mobile/online">在线购买</a>'
 +'       <a class="target_title" href="${basePath}support/mobile/price">优惠活动</a>'
 +'       <a class="target_title" href="${basePath}support/mobile/online">精品配饰</a>'
 +'       <a class="target_title" href="${basePath}support/mobile/online">APP下载</a>'
 +'       </div>'
 +'       </li>'
 +'       <li>'
 +'       <span class="sec_title"><i class="curstm_icon icon"></i>客户支持</span>'
 +'       <div class="thi_title">'
 +'       <a class="target_title" href="${basePath}customer/mobile/service">服务商查询</a>'
 +'       <a class="target_title" href="${basePath}memberreview/mobile/memberMain">会员中心</a>'
 +'       <a class="target_title" href="${basePath}customer/mobile/iRobot">在线客服</a>'
 +'       <a class="target_title" href="${basePath}customer/mobile/repair">维修与保养</a>'
 +'       <a class="target_title" href="${basePath}customer/mobile/aicbd">爱车宝典</a>'
 +'       <a class="target_title" href="${basePath}customer/mobile/policy">服务政策</a>'
 +'       </div>'
 +'       </li>'
 +'       <li>'
 +'       <span class="sec_title"><i class="sale_icon icon"></i>品牌活动</span>'
 +'       <div class="thi_title">'
 +'       <a class="target_title" href="${basePath}activities/mobile/sales">品牌活动</a>'
 +'       </div>'
 +'       </li>'
 +'       <li>'
 +'       <span class="sec_title"><i class="news_icon icon"></i>新闻中心</span>'
 +'       <div class="thi_title">'
 +'       <a class="target_title" href="${basePath}news/mobile/mtbd">新闻资讯</a>'
 +'       <a class="target_title" href="${basePath}news/mobile/hyzx">行业新闻</a>'
 +'       <a class="target_title" href="${basePath}news/mobile/video">媒体评测</a>'
 +'       </div>'
 +'       </li>'
 +'       <li class="last_li">'
 +'       <span class="sec_title"><i class="comin_icon icon"></i>关于品牌</span>'
 +'       <div class="thi_title">'
 +'       <a class="target_title" href="${basePath}about/profileMobile">技术研发</a>'
 +'       <a class="target_title" href="${basePath}about/developmentMobile">品牌介绍</a>'
 +'       <a class="target_title" href="${basePath}about/societyMobile">品牌荣誉</a>'
 +'       <a class="target_title" href="${basePath}job/joinusMobile">联系我们</a>'
 +'       <a class="target_title" href="${basePath}about/contactsMobile">下载中心</a>'
 +'       </div>'
 +'       </li>'
 +'       </ul>'
 +'       </div>'
 ...
 +'       <p class="vip_phone">'
 +'       <span>24小时贵宾热线：</span><a href="tel:4008988977">'
 +'       <i></i>4008-988-977</a>'
 +'       </p>'
 +'       <p class="foton_share">'
 +'       <span>福田官方公众平台：</span>'
