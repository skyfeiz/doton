...
(function(){
  ...
  p.initHeadStatus = function(){
    ...
    $(".modeDetail_head li").click(function(e){
      ...
      //cur.initChecked();
      $(".car_sliderBox").css({"position":"absolute","zIndex":"-1","opacity":0})
      $(".car_sliderBox").eq(index).css({"position":"relative","opacity":"1","zIndex":10});
    });
...
//                  '<img src="images/news/sp_02.png" class="videobf"/>'+
            ...
            if(data.data.length < 4){
              $("div.loadmore").css({"background-color":"#cccccc"}).html("已经到底啦~");
              cur.haveinf = false;
            }
          }
        });
